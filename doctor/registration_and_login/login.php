...
if (isset($_POST['signin'])) {
    ...
    $sql = "SELECT * FROM doctor_info WHERE name='$name' AND pass='$pass' ";
            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        ...
                        <a href="../../user/registration_and_login/login.php" class="signup-image-link" style="text-decoration: none; color: darkred; font-size: large;"> التسجيل الدخول كمستخدم</a>
                        <a href="../../admin/registration_and_login/login.php" class="signup-image-link" style="text-decoration: none; color: blueviolet; font-size: large;"> التسجيل الدخول كمدير موقع</a>
                    </div>
