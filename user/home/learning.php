                            ...
                            <div class="col-lg-3 col-md-6 mb-5">
                                ...
                                <div class="d-flex justify-content-start mt-4">
                                    ...
                                    <a class="btn btn-outline-primary rounded-circle text-center mr-2 px-0"
                                        ...
                                        href="https://www.facebook.com/Center.altahsse"><i
                            ...
                            <div class="col-lg-3 col-md-6 mb-5">
                                ...
                                <div class="d-flex flex-column justify-content-start">
                                    ...
                                    <a class="text-white mb-2" href="class.php"><i
                                            class="fa fa-angle-right mr-2"></i>البرامج العلاجيه</a>
                                    <a class="text-white mb-2" href="team.php"><i
                                            class="fa fa-angle-right mr-2"></i>اساتذنا</a>
                                    <a class="text-white mb-2" href="donation.php"><i
                                            class="fa fa-angle-right mr-2"></i>التبرع</a>
                        ...
                        <div class="container-fluid pt-5" style="border-top: 1px solid rgba(23, 162, 184, .2);;">
                            <p class="m-0 text-center text-white">
                                &copy; <a class="text-primary font-weight-bold"
                                    href="https://www.facebook.com/Center.altahsse">التخصصي للتخاطب</a>
